...
with open("../dataset/Laptops_corenlp/train_with_amr.json", 'r') as f:
    all_data = []
    data = json.load(f)
    for d in data:
        head = list(d['head']) 
...
with open("../dataset/Laptops_corenlp/test_with_amr.json", 'r') as f:
    all_data = []
    data = json.load(f)
    for d in data:
        head = list(d['head']) 
...
with open("../dataset/Restaurants_corenlp/train_with_amr.json", 'r') as f:
    all_data = []
    data = json.load(f)
    # print(data)
    for d in data:
...
with open("../dataset/Restaurants_corenlp/test_with_amr.json", 'r') as f:
    all_data = []
    data = json.load(f)
    # print(data)
    for d in data:
...
with open("../dataset/Tweets_corenlp/train_with_amr.json", 'r') as f:
    all_data = []
    data = json.load(f)
    # print(data)
    for d in data:
...
with open("../dataset/Tweets_corenlp/test_with_amr.json", 'r') as f:
    all_data = []
    data = json.load(f)
    # print(data)
    for d in data:
